...
import buu.informatics.s59161081.changmoney.database.Favorite
import buu.informatics.s59161081.changmoney.database.FavoriteDatabase
import buu.informatics.s59161081.changmoney.database.FavoriteDatabaseDao
...
class SleepDatabaseTest {
    ...
    fun insertAndGetFavorite() {
        val night = Favorite("","USD","US Dollar")
        favoriteDao.insert(night)
        val tonight = favoriteDao.getTonight()
